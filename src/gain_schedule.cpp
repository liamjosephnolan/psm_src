...
const double Kp_pitch_table[3][3] = {
    {115.37, 115.37, 115.37},  // pitch = -20, roll = [-15, 0, 15]
    {115.37, 115.37, 115.37},  // pitch =  0
    {115.37, 115.37, 115.37}   // pitch = +20
};

const double Kd_pitch_table[3][3] = {
    {0.1671, 0.1671, 0.1671}, // pitch = -20
    {0.1671, 0.1671, 0.1671}, // pitch =  0
    {0.1671, 0.1671, 0.1671}  // pitch = +20
};

const double Ki_pitch_table[3][3] = {
    {0.105649, 0.105649, 0.105649}, // pitch = -20
    {0.105649, 0.105649, 0.105649}, // pitch =  0
    {0.105649, 0.105649, 0.105649}  // pitch = +20
};
