...
const double Kp_pitch_table[3][3] = {
    {135.14, 155.14, 135.14},  // pitch = -20, roll = [-15, 0, 15]
    {135.37, 155.37, 135.37},  // pitch =  0
    {115.37, 135.37, 115.37}   // pitch = +20
};

const double Kd_pitch_table[3][3] = {
    {0.242221, 0.2221,  0.24221}, // pitch = -20
    {0.24671,  0.44671, 0.24671}, // pitch =  0
    {0.14671,  0.24671, 0.14671}  // pitch = +20
};

const double Ki_pitch_table[3][3] = {
    {0.11242, 0.11242, 0.11242}, // pitch = -20
    {0.11649, 0.11649, 0.11649}, // pitch =  0
    {0.11649, 0.11649, 0.11649}  // pitch = +20
};
